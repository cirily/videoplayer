...
static QApplication *createApplication(int &argc, char **argv, const QString &applicationName)
{
    ...
    QApplication::setOrganizationName("piscesys");
    QApplication::setApplicationName(applicationName);
    QApplication::setOrganizationDomain("piscesys.com");
    QApplication::setApplicationDisplayName("Video Player");
    QApplication::setWindowIcon(QIcon::fromTheme("pisces-videoplayer"));
    ...
    : m_app(createApplication(argc, argv, applicationName))
{
    ...
    QString mspris2Name(QStringLiteral("org.mpris.MediaPlayer2.pisces.videoplayer"));
    ...
    // Translations
    QLocale locale;
    QString qmFilePath = QString("%1/%2.qm").arg("/usr/share/pisces-videoplayer/translations/").arg(locale.name());
